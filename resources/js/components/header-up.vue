        ...
        <nav  class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item active">
                    <router-link exact-active-class="active-nav" class="nav-link" to="/">Home
                        <i class="bi bi-house-fill"></i>                    </router-link>
                </li>
                <li class="nav-item" id="login-btn">
                    <router-link exact-active-class="active-nav" class="nav-link" to="/login">Login</router-link>
                </li>
                <li class="nav-item" id="register-btn">
                    <router-link exact-active-class="active-nav" class="nav-link" to="/register">Register</router-link>
                </li>

                <li class="nav-item" id="categories-btn" style="display:bloc">
                    <router-link exact-active-class="active-nav" class="nav-link" to="/categories">Categories
                        <i class="bi bi-list-ul"></i></router-link>
                </li>

                <li class="nav-item" id="cart-btn ">
                    <router-link exact-active-class="active-nav" class="nav-link" to="/cart">Cart
                ...
                <li class="nav-item" id="pay-btn" style="display:bloc">
                    <router-link exact-active-class="active-nav" class="nav-link" to="/pay">Payments
                ...
                <li class="nav-item" id="profile-btn" style="display:bloc">
                    <router-link exact-active-class="active-nav" class="nav-link" to="/profile">Profile
